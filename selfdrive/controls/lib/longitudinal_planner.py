...
A_CRUISE_MIN_VALS_ECO_TUNE = [-0.005, -0.010, -0.12, -0.24, -0.40, -0.36, -0.32, -0.28, -0.28, -0.25, -0.25]
A_CRUISE_MAX_VALS_ECO_TUNE = [3.5, 3.5, 1.8, 1.1, .76, .62, .47, .36, .28, .09]

A_CRUISE_MIN_VALS_SPORT_TUNE = [-0.010, -0.015, -0.16, -0.28, -0.42, -0.42, -0.40, -0.35, -0.35, -0.30, -0.30]
